...
public class KeyHandlerController {
  ...
  /**
   * Constructs a new instance of the KeyHandler class. The constructor initializes the game grid
   * and game state controller.
   *
  ...
  /**
   * Executes the corresponding action based on the provided key code. If the key code matches any
   * predefined cheat keys, the corresponding action is executed immediately. Otherwise, a key
   * handler is instantiated based on the key code and executed to perform the appropriate action.
   *
  ...
  /**
   * Moves the enemy in the game grid. This method instantiates an enemy key handler and calls its
