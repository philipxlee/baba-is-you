...
public interface Strategy {
  ...
  /**
   * Defines how this strategy interacts with another strategy acting upon the associated block. Can
   * be used for behaviors that depend on the interaction between different types of blocks or
   * strategies, such as a pushable block reacting to a controllable block.
   *
