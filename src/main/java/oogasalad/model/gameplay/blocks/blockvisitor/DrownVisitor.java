...
import oogasalad.model.gameplay.strategies.attributes.Drownable;

/**
 * Visitor pattern for the drownable behavior.
 */
public class DrownVisitor implements BlockVisitor {

  /**
   * Adds the drownable behavior to the baba block.
   *
   * @param baba the baba block
   */
  @Override
  public void visit(BabaVisualBlock baba) {
    baba.addBehavior(new Drownable());
  }

  /**
   * Adds the drownable behavior to the wall block.
   *
   * @param wall the wall block.
   */
  @Override
  public void visit(WallVisualBlock wall) {
    wall.addBehavior(new Drownable());
  }

  /**
   * Adds the drownable behavior to the flag block.
   *
   * @param flag the flag block.
   */
  @Override
  public void visit(FlagVisualBlock flag) {
    flag.addBehavior(new Drownable());
  }

  /**
   * Adds the drownable behavior to the rock block.
   *
   * @param rock the rock block.
   */
  @Override
  public void visit(RockVisualBlock rock) {
    rock.addBehavior(new Drownable());
  }

  /**
   * Adds the drownable behavior to the empty block.
   *
   * @param empty the empty block.
   */
  @Override
  public void visit(EmptyVisualBlock empty) {
    empty.addBehavior(new Drownable());
  }

  /**
   * Adds the drownable behavior to the water block.
   *
   * @param water the water block.
   */
  @Override
  public void visit(WaterVisualBlock water) {
    water.addBehavior(new Drownable());
  }

  /**
   * Adds the drownable behavior to the lava block.
   *
   * @param lava the lava block.
   */
  @Override
  public void visit(LavaVisualBlock lava) {
    lava.addBehavior(new Drownable());
  }
