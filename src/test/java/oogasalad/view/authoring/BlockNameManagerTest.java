...
public class BlockNameManagerTest {
    ...
    public void testExtractBlocks() {
        ...
        assertEquals("path/to/image.png", extractedBlock.getImagePath(), "The image path should match.");
    }
    ...
    public void testCategoryMatch() {
        ...
        assertTrue(manager.isCategoryMatch(categories, ""), "Should match any category when filter is empty");
